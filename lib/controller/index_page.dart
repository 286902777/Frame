...
class _IndexPageState extends State<IndexPage>
  ...
  List<UserPools> userLists = <UserPools>[];
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: Obx(
                () => isNetwork.value
                    ? (AppDataBase.instance.items
                                  .where((item) => item.netMovie == 0)
                                  .toList()
                                  .isNotEmpty ||
                              AppDataBase.instance.historyItems.isNotEmpty ||
                              AppDataBase.instance.users.isNotEmpty
                          ? _contentView()
                          : _importWidget())
                    : _emptyWidget(),
              ),
  ...
  Widget _contentView() {
    List<VideoModel> dbLists = AppDataBase.instance.items
        .where((item) => item.netMovie == 0)
        .toList();
    return Column(
      ...
      children: [
        Visibility(
          visible: AppDataBase.instance.historyItems.isNotEmpty,
          child: IndexHistoryCell(),
        ),
        ...
        Visibility(
          ...
          child: IndexListCell(
            lists: dbLists,
            clickItem: (index) {
              List<VideoModel> lists = dbLists;
              for (int i = 0; i < lists.length; i++) {
                if (i == index) {
                  playSource = PlaySource.import;
                  PlayManager.pushPage(lists[i], lists, false);
                  break;
                }
              }
            },
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Image.asset(Assets.assetsNoContent, width: 120, height: 120),
                  SizedBox(height: 4),
                  Text(
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Image.asset(Assets.assetsNoNetwork, width: 120, height: 120),
                  SizedBox(height: 4),
                  Text(
